<div class="container-fluid">
        ...
        <p>Selamat Datang <strong><?php echo $username;?></strong> di Sistem Informasi Akademik Universitas 
        Mukti Mulia, Anda login sebagai <strong> <?php echo $level; ?></strong></p>
        <hr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title " id="exampleModalLabel"><i class="fas fa-cogs"></i> Control Panel</h1>
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-info text-center">
                <a href="<?php echo base_url()?>"><p class="nav-li nk small text-info">CEATK TRANSKIP</p></a>
